    ...
    <div className="p-3 bg-success border-bottom">
      <Nav className="d-flex justify-content-between align-items-center">
        <div className="d-flex justify-content-around align-items-center col-md-5 col-xl-6">
          ...
          <Nav.Item>
            <Link className='fs-5 text-white' href="/tutors">Find Quran Teachers</Link>
          </Nav.Item>
          <Nav.Item>
            <Link className='fs-5 text-white' href="/home">Plans & Pricing</Link>
          </Nav.Item>
          <Nav.Item>
            <Link className='fs-5 text-white' href="/home">Messages (6)</Link>
          </Nav.Item>
        </div>
